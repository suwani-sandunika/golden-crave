...
private static String manager_id;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manager SignIn");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(jImagePanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE)
                        .addGap(16, 16, 16))))
        );
       ...
       String mobile = jTextField1.getText();
        ...
        if (mobile.isEmpty()) {
            ...
            try {
                ...
                ResultSet rs = MySQL.execute("SELECT * FROM `manager` WHERE `mobile`='" + mobile + "' AND `password`='" + password + "' ");
...
//                      int userid = rs.getInt("user_type_id");
                        ...
                        manager_id = rs.getString("id");
                        
                        ManagerDashBoard h = new ManagerDashBoard(manager_id);
                        h.setVisible(true);
                        this.dispose();
